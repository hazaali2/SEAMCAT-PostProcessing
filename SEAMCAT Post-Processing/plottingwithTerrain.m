...
if ~isempty(workspaceElement)
    ...
    [victimRx, victimTx, offendingInterferers, interferers] = extractLocationsUsingTerrain(resultsDoc, interferenceMappings.(selectedInterference), threshold, lat, lon, false);
